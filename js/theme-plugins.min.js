!function (t) {
    t.fn.parallax = function (e) {
        var o = t(window).height(), i = t.extend({speed: .15}, e);
        return this.each(function () {
            var e = t(this);
            t(document).scroll(function () {
                var n = t(window).scrollTop(), s = e.offset().top, a = e.outerHeight();
                if (!(n >= s + a || s >= n + o)) {
    ...
    t.fn.countTo = function (e) {
        return e = e || {}, t(this).each(function () {
            ...
            var n = t.extend({}, t.fn.countTo.defaults, {
                ...
                }, e), s = Math.ceil(n.speed / n.refreshInterval), a = (n.to - n.from) / s, r = this, l = t(this), p = 0,
                h = n.from, c = l.data("countTo") || {};
    ...
    t.fn.appear = function (e, o) {
        var i = t.extend({data: void 0, one: !0, accX: 0, accY: 0}, o);
        return this.each(function () {
            var o = t(this);
            if (o.appeared = !1, !e) return void o.trigger("appear", i.data);
            var n = t(window), s = function () {
                if (!o.is(":visible")) return void (o.appeared = !1);
                var t = n.scrollLeft(), e = n.scrollTop(), s = o.offset(), a = s.left, r = s.top, l = i.accX,
                    p = i.accY, h = o.height(), c = n.height(), u = o.width(), d = n.width();
    ...
    def: "easeOutQuad", swing: function (t, e, o, i, n) {
    ...
    e.c = {}, e.c.d = t(document), e.c.t = function (t) {
        ...
        e.o.call(this), this.startAngle = null, this.xy = null, this.radius = null, this.lineWidth = null, this.cursorExt = null, this.w2 = null, this.PI2 = 2 * Math.PI, this.extend = function () {
            ...
            var e, n, s, a, r = this, l = function (t) {
                t.preventDefault();
                var s = t.originalEvent, a = s.detail || s.wheelDeltaX, l = s.detail || s.wheelDeltaY,
            ...
            }, p = 1, h = {37: -r.o.step, 38: r.o.step, 39: r.o.step, 40: -r.o.step};
            ...
            var t, e = this.g, o = this.arc(this.cv), i = 1;
    ...
    var e = -1, o = -1, i = function (t) {
        ...
        var o = 1, n = t(e), s = null, a = [];
        return n.each(function () {
            var e = t(this), n = e.offset().top - i(e.css("margin-top")), r = a.length > 0 ? a[a.length - 1] : null;
    ...
    a._groups = [], a._throttle = 80, a._maintainScroll = !1, a._beforeUpdate = null, a._afterUpdate = null, a._apply = function (e, o) {
        var r = s(o), l = t(e), p = [l], h = t(window).scrollTop(), c = t("html").outerHeight(!0),
    ...
    var t = function (t, e) {
        ...
        var o, i = Array.prototype.slice.call(arguments, 2), n = [], s = t.length;
        ...
        }); else for (o = 0; s > o; o++) callback_params = i, callback_params.splice(0, 0, t[o]), n.push(e.apply(this, callback_params));
        return n
    }, i = function (t) {
        var e, o = [];
        for (e = 0; e < t.length; e++) o = o.concat(t[e]);
        return o
    }, n = function (t, e) {
        var o = t[0], i = t[1];
        return e && (o = t[1], i = t[0]), new google.maps.LatLng(o, i)
    }, s = function (t, e) {
        var o;
        for (o = 0; o < t.length; o++) t[o] instanceof google.maps.LatLng || (t[o] = t[o].length > 0 && "object" == typeof t[o][0] ? s(t[o], e) : n(t[o], e));
        return t
    }, a = function (t, e) {
        var o, t = t.replace("#", "");
        return o = "jQuery" in this && e ? $("#" + t, e)[0] : document.getElementById(t)
    }, r = function (t) {
        var e = 0, o = 0;
        ...
        "use strict";
        var e = document, o = function (i) {
            if (!this) return new o(i);
            ...
            var n, s = this,
                ...
                c = i.el || i.div, u = i.markerClusterer, d = google.maps.MapTypeId[i.mapType.toUpperCase()],
                m = new google.maps.LatLng(i.lat, i.lng), f = i.zoomControl || !0,
                g = i.zoomControlOpt || {style: "DEFAULT", position: "TOP_LEFT"}, v = g.style || "DEFAULT",
                y = g.position || "TOP_LEFT", w = i.panControl || !0, b = i.mapTypeControl || !0,
                k = i.scaleControl || !0, x = i.streetViewControl || !0, I = I || !0, C = {},
                P = {zoom: this.zoom, center: m, mapTypeId: d}, $ = {
                    panControl: w,
                    zoomControl: f,
                    ...
                    scaleControl: k,
                    streetViewControl: x,
                    overviewMapControl: I
                };
            if (this.el = "string" == typeof i.el || "string" == typeof i.div ? a(c, i.context) : c, "undefined" == typeof this.el || null === this.el) throw"No element defined.";
            for (window.context_menu = window.context_menu || {}, window.context_menu[s.el.id] = {}, this.controls = [], this.overlays = [], this.layers = [], this.singleLayers = {}, this.markers = [], this.polylines = [], this.routes = [], this.polygons = [], this.infoWindow = null, this.overlay_el = null, this.zoom = i.zoom, this.registered_events = {}, this.el.style.width = i.width || this.el.scrollWidth || this.el.offsetWidth, this.el.style.height = i.height || this.el.scrollHeight || this.el.offsetHeight, google.maps.visualRefresh = i.enableNewStyle, n = 0; n < h.length; n++) delete i[h[n]];
            for (1 != i.disableDefaultUI && (P = t(P, $)), C = t(P, i), n = 0; n < l.length; n++) delete C[l[n]];
            for (n = 0; n < p.length; n++) delete C[p[n]];
            this.map = new google.maps.Map(this.el, C), u && (this.markerClusterer = u.apply(this, [this.map]));
            var M = function (t, e) {
                var o = "", i = window.context_menu[s.el.id][t];
                for (var n in i) if (i.hasOwnProperty(n)) {
                    var l = i[n];
                    o += '<li><a id="' + t + "_" + n + '" href="#">' + l.title + "</a></li>"
                }
                if (a("gmaps_context_menu")) {
                    var p = a("gmaps_context_menu");
                    p.innerHTML = o;
                    var n, h = p.getElementsByTagName("a"), c = h.length;
                    for (n = 0; c > n; n++) {
                        var u = h[n], d = function (o) {
                            o.preventDefault(), i[this.id.replace(t + "_", "")].action.apply(s, [e]), s.hideContextMenu()
                        };
                        google.maps.event.clearListeners(u, "click"), google.maps.event.addDomListenerOnce(u, "click", d, !1)
                    }
                    var m = r.apply(this, [s.el]), f = m[0] + e.pixel.x - 15, g = m[1] + e.pixel.y - 15;
                    p.style.left = f + "px", p.style.top = g + "px", p.style.display = "block"
                }
            };
            this.buildContextMenu = function (t, e) {
                if ("marker" === t) {
                    ...
                    o.setMap(s.map), o.draw = function () {
                        var i = o.getProjection(), n = e.marker.getPosition();
                        e.pixel = i.fromLatLngToContainerPixel(n), M(t, e)
                    }
                } else M(t, e)
            }, this.setContextMenu = function (t) {
                window.context_menu[s.el.id][t.control] = {};
                var o, i = e.createElement("ul");
                for (o in t.options) if (t.options.hasOwnProperty(o)) {
                    var n = t.options[o];
                    window.context_menu[s.el.id][t.control][n.name] = {title: n.title, action: n.action}
                }
                ...
                google.maps.event.addDomListener(r, "mouseout", function (t) {
            ...
            google.maps.event.addListener(this.map, "rightclick", function (t) {
                ...
                var t, e = [], o = this.markers.length;
                for (t = 0; o > t; t++) "boolean" == typeof this.markers[t].visible && this.markers[t].visible && e.push(this.markers[t].getPosition());
                this.fitLatLngBounds(e)
            }, this.fitLatLngBounds = function (t) {
                var e, o = t.length, i = new google.maps.LatLngBounds;
                for (e = 0; o > e; e++) i.extend(t[e]);
                this.map.fitBounds(i)
            }, this.setCenter = function (t, e, o) {
                this.map.panTo(new google.maps.LatLng(t, e)), o && o()
            ...
            var S, O = [];
            for (S in this.map) "function" != typeof this.map[S] || this[S] || O.push(S);
            for (n = 0; n < O.length; n++) !function (t, e, o) {
                t[o] = function () {
    ...
    l.prototype.createControl = function (t) {
        ...
        for (var o in t.style) e.style[o] = t.style[o];
        ...
        for (var i in t.events) !function (e, o) {
            google.maps.event.addDomListener(e, o, function () {
                t.events[o].apply(this, [this])
            })
        }(e, i);
        return e.index = 1, e
        ...
        var e, o = null;
        for (e = 0; e < this.controls.length; e++) this.controls[e] == t && (o = this.controls[e].position, this.controls.splice(e, 1));
        if (o) for (e = 0; e < this.map.controls.length; e++) {
        ...
        var o = this, i = e.details, n = e.fences, s = e.outside,
            a = {position: new google.maps.LatLng(e.lat, e.lng), map: null}, r = t(a, e);
        ...
        if (l.fences = n, e.infoWindow) {
            ...
            for (var p = ["closeclick", "content_changed", "domready", "position_changed", "zindex_changed"], h = 0; h < p.length; h++) !function (t, o) {
                e.infoWindow[o] && google.maps.event.addListener(t, o, function (t) {
                    e.infoWindow[o].apply(this, [t])
                })
            }(l.infoWindow, p[h])
        }
        for (var c = ["animation_changed", "clickable_changed", "cursor_changed", "draggable_changed", "flat_changed", "icon_changed", "position_changed", "shadow_changed", "shape_changed", "title_changed", "visible_changed", "zindex_changed"], u = ["dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"], h = 0; h < c.length; h++) !function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function () {
                e[o].apply(this, [this])
            })
        }(l, c[h]);
        for (var h = 0; h < u.length; h++) !function (t, o, i) {
            e[i] && google.maps.event.addListener(o, i, function (o) {
                o.pixel || (o.pixel = t.getProjection().fromLatLngToPoint(o.latLng)), e[i].apply(this, [o])
            })
        }(this.map, l, u[h]);
        return google.maps.event.addListener(l, "click", function () {
            this.details = i, e.click && e.click.apply(this, [this]), l.infoWindow && (o.hideInfoWindows(), l.infoWindow.open(o.map, l))
            ...
            o.checkMarkerGeofence(l, function (t, e) {
                s(t, e)
            })
        }), l
        ...
        for (var e, o = 0; e = t[o]; o++) this.addMarker(e);
        return this.markers
        ...
        if ("undefined" == typeof t) {
            ...
            for (var o = 0; o < t.length; o++) {
                var n = this.markers.indexOf(t[o]);
                if (n > -1) {
        ...
        var e = new google.maps.OverlayView, o = !0;
        return e.setMap(this.map), null != t.auto_show && (o = t.auto_show), e.onAdd = function () {
            var o = document.createElement("div");
            o.style.borderStyle = "none", o.style.borderWidth = "0px", o.style.position = "absolute", o.style.zIndex = 100, o.innerHTML = t.content, e.el = o, t.layer || (t.layer = "overlayLayer");
            var i = this.getPanes(), n = i[t.layer], s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            n.appendChild(o);
            for (var a = 0; a < s.length; a++) !function (t, e) {
            ...
            var s = e.el, a = s.children[0], r = a.clientHeight, l = a.clientWidth;
            switch (t.verticalAlign) {
                case"top":
                    s.style.top = n.y - r + t.verticalOffset + "px";
                    break;
                default:
                case"middle":
                    s.style.top = n.y - r / 2 + t.verticalOffset + "px";
                    break;
                case"bottom":
            ...
            switch (t.horizontalAlign) {
                case"left":
                    s.style.left = n.x - l + t.horizontalOffset + "px";
                    break;
                default:
                case"center":
                    s.style.left = n.x - l / 2 + t.horizontalOffset + "px";
                    break;
                case"right":
                    s.style.left = n.x + t.horizontalOffset + "px"
            }
            s.style.display = o ? "block" : "none", o || t.show.apply(this, [s])
        }, e.onRemove = function () {
            var o = e.el;
            t.remove ? t.remove.apply(this, [o]) : (e.el.parentNode.removeChild(e.el), e.el = null)
        ...
        var e = [], o = t.path;
        if (o.length) if (void 0 === o[0][0]) e = o; else for (var i, n = 0; i = o[n]; n++) e.push(new google.maps.LatLng(i[0], i[1]));
        var s = {
            map: this.map,
            path: e,
        ...
        for (var a = new google.maps.Polyline(s), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], p = 0; p < r.length; p++) !function (e, o) {
            t[o] && google.maps.event.addListener(e, o, function (e) {
                t[o].apply(this, [e])
            })
        }(a, r[p]);
        return this.polylines.push(a), l.fire("polyline_added", a, this), a
        ...
        for (var o = new google.maps.Circle(e), i = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], n = 0; n < i.length; n++) !function (t, o) {
        ...
        e.bounds = o;
        for (var i = new google.maps.Rectangle(e), n = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], s = 0; s < n.length; s++) !function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function (t) {
                e[o].apply(this, [t])
            })
        }(i, n[s]);
        ...
        var n = !1;
        e.hasOwnProperty("useGeoJSON") && (n = e.useGeoJSON), delete e.useGeoJSON, e = t({map: this.map}, e), 0 == n && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = i(o(e.paths, s, n)));
        for (var a = new google.maps.Polygon(e), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], p = 0; p < r.length; p++) !function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function (t) {
                e[o].apply(this, [t])
            })
        }(a, r[p]);
        return this.polygons.push(a), l.fire("polygon_added", a, this), a
        ...
        var e = t.events;
        delete t.events;
        var o = t, i = new google.maps.FusionTablesLayer(o);
        for (var n in e) !function (t, o) {
        ...
        switch (t) {
            ...
            case"bicycling":
                ...
                break;
            case"panoramio":
                this.singleLayers.panoramio = o = new google.maps.panoramio.PanoramioLayer, o.setTag(e.filter), delete e.filter, e.click && google.maps.event.addListener(o, "click", function (t) {
                    e.click(t), delete e.click
                });
                break;
            case"places":
                if (this.singleLayers.places = o = new google.maps.places.PlacesService(this.map), e.search || e.nearbySearch || e.radarSearch) {
                    var i = {
                    ...
                    e.radarSearch && o.radarSearch(i, e.radarSearch), e.search && o.search(i, e.search), e.nearbySearch && o.nearbySearch(i, e.nearbySearch)
                }
                if (e.textSearch) {
                    var n = {
                        bounds: e.bounds || null,
                    ...
                    o.textSearch(n, e.textSearch)
                }
        }
        return void 0 !== o ? ("function" == typeof o.setOptions && o.setOptions(e), "function" == typeof o.setMap && o.setMap(this.map), o) : void 0
    ...
    return l.prototype.getRoutes = function (e) {
        ...
        var o = {avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: []}, i = t(o, e);
        i.origin = /string/.test(typeof e.origin) ? e.origin : new google.maps.LatLng(e.origin[0], e.origin[1]), i.destination = /string/.test(typeof e.destination) ? e.destination : new google.maps.LatLng(e.destination[0], e.destination[1]), i.travelMode = p, i.unitSystem = h, delete i.callback, delete i.error;
        var n = this, s = new google.maps.DirectionsService;
        s.route(i, function (t, o) {
            if (o === google.maps.DirectionsStatus.OK) {
                for (var i in t.routes) t.routes.hasOwnProperty(i) && n.routes.push(t.routes[i]);
        ...
        e = t({
            ...
            path: !1,
            samples: 256
        }, e), e.locations.length > 0 && e.locations[0].length > 0 && (e.locations = i(o([e.locations], s, !1)));
        var n = e.callback;
        delete e.callback;
        var a = new google.maps.ElevationService;
        if (e.path) {
            var r = {path: e.locations, samples: e.samples};
            a.getElevationAlongPath(r, function (t, e) {
                n && "function" == typeof n && n(t, e)
            })
        } else delete e.path, delete e.samples, a.getElevationForLocations(e, function (t, e) {
            n && "function" == typeof n && n(t, e)
        })
        ...
        this.getRoutes({
            ...
            callback: function (o) {
                if (o.length > 0) {
                    ...
                    t.hasOwnProperty("icons") && (i.icons = t.icons), e.drawPolyline(i), t.callback && t.callback(o[o.length - 1])
                }
            }
        })
        ...
        if (t.origin && t.destination) this.getRoutes({
            ...
            callback: function (e) {
                if (e.length > 0 && t.start && t.start(e[e.length - 1]), e.length > 0 && t.step) {
                    var o = e[e.length - 1];
                    if (o.legs.length > 0) for (var i, n = o.legs[0].steps, s = 0; i = n[s]; s++) i.step_number = s, t.step(i, o.legs[0].steps.length - 1)
                }
                e.length > 0 && t.end && t.end(e[e.length - 1])
            }
        }); else if (t.route && t.route.legs.length > 0) for (var e, o = t.route.legs[0].steps, i = 0; e = o[i]; i++) e.step_number = i, t.step(e)
        ...
        if (t.origin && t.destination) this.getRoutes({
            ...
            callback: function (o) {
                if (o.length > 0 && t.start && t.start(o[o.length - 1]), o.length > 0 && t.step) {
                    var i = o[o.length - 1];
                    if (i.legs.length > 0) for (var n, s = i.legs[0].steps, a = 0; n = s[a]; a++) {
                        n.step_number = a;
                        var r = {
                            path: n.path,
                            strokeColor: t.strokeColor,
                        ...
                        t.hasOwnProperty("icons") && (r.icons = t.icons), e.drawPolyline(r), t.step(n, i.legs[0].steps.length - 1)
                    }
                }
                o.length > 0 && t.end && t.end(o[o.length - 1])
            }
        }); else if (t.route && t.route.legs.length > 0) for (var o, i = t.route.legs[0].steps, n = 0; o = i[n]; n++) {
            o.step_number = n;
            var s = {
                path: o.path,
                strokeColor: t.strokeColor,
            ...
            t.hasOwnProperty("icons") && (s.icons = t.icons), e.drawPolyline(s), t.step(o)
        }
    }, l.Route = function (t) {
    ...
    }, l.prototype.checkGeofence = function (t, e, o) {
        return o.containsLatLng(new google.maps.LatLng(t, e))
    }, l.prototype.checkMarkerGeofence = function (t, e) {
        if (t.fences) for (var o, i = 0; o = t.fences[i]; i++) {
            var n = t.getPosition();
            this.checkGeofence(n.lat(), n.lng(), o) || e(t, o)
        }
        ...
        if (e.size = t.size || [this.el.clientWidth, this.el.clientHeight], e.lat = this.getCenter().lat(), e.lng = this.getCenter().lng(), this.markers.length > 0) {
            e.markers = [];
            for (var o = 0; o < this.markers.length; o++) e.markers.push({
        ...
        var p = t.size;
        p ? (p.join && (p = p.join("x")), delete t.size) : p = "630x300", i.push("size=" + p), t.zoom || t.zoom === !1 || (t.zoom = 15);
        var h = t.hasOwnProperty("sensor") ? !!t.sensor : !0;
        delete t.sensor, i.push("sensor=" + h);
        for (var c in t) t.hasOwnProperty(c) && i.push(c + "=" + t[c]);
        if (s) for (var u, d, m = 0; o = s[m]; m++) {
            u = [], o.size && "normal" !== o.size ? (u.push("size:" + o.size), delete o.size) : o.icon && (u.push("icon:" + encodeURI(o.icon)), delete o.icon), o.color && (u.push("color:" + o.color.replace("#", "0x")), delete o.color), o.label && (u.push("label:" + o.label[0].toUpperCase()), delete o.label), d = o.address ? o.address : o.lat + "," + o.lng, delete o.address, delete o.lat, delete o.lng;
            for (var c in o) o.hasOwnProperty(c) && u.push(c + ":" + o[c]);
            u.length || 0 === m ? (u.push(d), u = u.join("|"), i.push("markers=" + encodeURI(u))) : (u = i.pop() + encodeURI("|" + d), i.push(u))
        }
        if (a) for (var m = 0; m < a.length; m++) {
            var f = [];
            a[m].featureType && f.push("feature:" + a[m].featureType.toLowerCase()), a[m].elementType && f.push("element:" + a[m].elementType.toLowerCase());
            for (var g = 0; g < a[m].stylers.length; g++) for (var v in a[m].stylers[g]) {
                var y = a[m].stylers[g][v];
                ("hue" == v || "color" == v) && (y = "0x" + y.substring(1)), f.push(v + ":" + y)
            }
            var w = f.join("|");
            "" != w && i.push("style=" + w)
        }
        if (r) {
            if (o = r, r = [], o.strokeWeight && r.push("weight:" + parseInt(o.strokeWeight, 10)), o.strokeColor) {
                var b = e(o.strokeColor, o.strokeOpacity);
                r.push("color:" + b)
            }
            if (o.fillColor) {
                var k = e(o.fillColor, o.fillOpacity);
                r.push("fillcolor:" + k)
            }
            var x = o.path;
            if (x.join) for (var I, g = 0; I = x[g]; g++) r.push(I.join(",")); else r.push("enc:" + x);
            r = r.join("|"), i.push("path=" + encodeURI(r))
        }
        var C = window.devicePixelRatio || 1;
        return i.push("scale=" + C), i = i.join("&"), n + i
        ...
        var o = new google.maps.ImageMapType(e);
        this.map.mapTypes.set(t, o)
        ...
        for (var r = new google.maps.StreetViewPanorama(o, n), s = 0; s < i.length; s++) !function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function () {
                e[o].apply(this)
            })
        }(r, i[s]);
        ...
        l.off(t, this)
    }, l.custom_events = ["marker_added", "marker_removed", "polyline_added", "polyline_removed", "polygon_added", "polygon_removed", "geolocated", "geolocation_failed"], l.on = function (t, e, o) {
        if (-1 == l.custom_events.indexOf(t)) return e instanceof l && (e = e.map), google.maps.event.addListener(e, t, o);
        var i = {handler: o, eventName: t};
    ...
    }, l.fire = function (t, e, o) {
        if (-1 == l.custom_events.indexOf(t)) google.maps.event.trigger(e, t, Array.prototype.slice.apply(arguments).slice(2)); else if (t in o.registered_events) for (var i = o.registered_events[t], n = 0; n < i.length; n++) !function (t, e, o) {
            t.apply(e, [o])
        }(i[n].handler, o, e)
        ...
        var e = t.callback;
        t.hasOwnProperty("lat") && t.hasOwnProperty("lng") && (t.latLng = new google.maps.LatLng(t.lat, t.lng)), delete t.lat, delete t.lng, delete t.callback, this.geocoder.geocode(t, function (t, o) {
            e(t, o)
        })
    }, google.maps.Polygon.prototype.getBounds || (google.maps.Polygon.prototype.getBounds = function () {
        for (var t, e = new google.maps.LatLngBounds, o = this.getPaths(), i = 0; i < o.getLength(); i++) {
            t = o.getAt(i);
            for (var n = 0; n < t.getLength(); n++) e.extend(t.getAt(n))
        }
        return e
        ...
        for (var o = !1, i = this.getPaths().getLength(), n = 0; i > n; n++) for (var s = this.getPaths().getAt(n), a = s.getLength(), r = a - 1, l = 0; a > l; l++) {
            var p = s.getAt(l), h = s.getAt(r);
            (p.lng() < t.lng() && h.lng() >= t.lng() || h.lng() < t.lng() && p.lng() >= t.lng()) && p.lat() + (t.lng() - p.lng()) / (h.lng() - p.lng()) * (h.lat() - p.lat()) < t.lat() && (o = !o), r = l
        }
        return o
        ...
        if (0 === o) return -1;
        var i = 0;
        if (arguments.length > 1 && (i = Number(arguments[1]), i != i ? i = 0 : 0 != i && 1 / 0 != i && i != -1 / 0 && (i = (i > 0 || -1) * Math.floor(Math.abs(i)))), i >= o) return -1;
        for (var n = i >= 0 ? i : Math.max(o - Math.abs(i), 0); o > n; n++) if (n in e && e[n] === t) return n;
        return -1
    }), l
